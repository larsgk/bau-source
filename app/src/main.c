/*
 * Copyright (c) 2024 Lars Knudsen (added simple BAU display support)
...
int main(void)
{
	...
	while (true) {
		...
		/* Update QR Code in GUI */
		gui_update_qr_code(&advInfo.addr->a, broadcast_id, CONFIG_BT_DEVICE_NAME);
